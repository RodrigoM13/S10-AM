...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var btnAddGame: CardView
    private lateinit var btnViewGames: CardView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupClickListeners()
        setupGameFeatures() // ✅ Importante: habilita clics en los CardView
    ...
    private fun showEmailVerificationDialog() {
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("Enviar verificación") { _, _ -> sendEmailVerification() }
